...
export const attendanceService = {
  ...
  punchIn: (data: PunchRequest) => apiClient.post<AttendanceRecord>('/attendance/punch-in', data),
  punchOut: (data: PunchRequest) => apiClient.post<AttendanceRecord>('/attendance/punch-out', data),
